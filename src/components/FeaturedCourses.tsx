    ...
    <div className="py-12 bg-gray-900">
      <div>
                ...
                <BackgroundGradient className="flex flex-col rounded-[22px] bg-white dark:bg-zinc-900 overflow-hidden h-full max-w-sm">
                  <div className="p-2 sm:p-6 flex flex-col items-center text-center flex-grow">
                    ...
                    <Link
                      ...
                      className="bg-white text-black mt-4 px-2 py-0.5 font-bold rounded-sm "
                    >
                      Learn More
                    </Link>
                  </div>
        ...
        <div className="mt-20 text-center">
          <Link
            href={"/courses"}
            className="px-4 py-2 rounded border  border-neutral-600 text-neutral-700 bg-white hover:bg-gray-200 transition duration-200 font-bold"
          >
            View All Courses
          </Link>
        </div>
